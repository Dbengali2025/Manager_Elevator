...
export default function GlobalError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-offWhite text-center px-md">
      ...
      <div className="flex items-center gap-md">
        ...
        <Link
          href="/dashboard"
          className="rounded-md border border-paleGray px-xl py-sm text-body font-medium text-charcoal hover:bg-paleGray/50 transition-colors"
        >
          Go to Dashboard
        </Link>
      </div>
