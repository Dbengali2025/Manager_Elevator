...
export default function BillingControls({ hasCustomer, subscribed, selectedPlan }: {
  ...
  return <div className="space-y-lg">
    ...
    <p className="text-body text-charcoal/70">Subscriptions renew automatically. Cancel anytime through Manage billing. After your free 7-day trial, platform access requires an active subscription.</p>
