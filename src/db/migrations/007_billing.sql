...
-- Lesson downloads already go through an authenticated server proxy. Disable
-- public storage URLs as part of the same paid-access rollout.
UPDATE storage.buckets SET public = false, updated_at = now() WHERE name = 'lesson-resources';
COMMIT;
